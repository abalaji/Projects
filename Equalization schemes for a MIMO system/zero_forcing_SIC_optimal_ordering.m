...
hold on;
semilogy(Eb_N0_dB,BER3,'-go','LineWidth',2);
axis([0 25 10^-5 0.5])
grid on
legend('theoretical (Tr=2,Rcvr=2, ZF)', 'theoretical (Tr=1,Rcvr=2, MRC)', 'simulation (Tr=2, Rcvr=2, ZF-SIC-OO)');
xlabel('Average Eb/No in dB');
ylabel('BER');
title('BER for ZF-SIC-optimal ordering equalizer');
